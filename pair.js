            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'LIZAMWOL-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://chat.whatsapp.com/IDik0Yl1FnVGE6kiXsKUAG) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [MUDIYANMASS GitHub Repo](https://github.com/mudiyanmas/)  

🚀 _Thanks for choosing LIZAMWOL — Let the automation begin!_ ✨`;
